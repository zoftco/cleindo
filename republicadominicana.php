...
<!--Barra de Usuario Logueado-->
<div class="container-fluid" style="background-image:url('img/CIUDAD-DE-SANTO-DOMINGO.jpg');background-size: contain;background-repeat: no-repeat;background-position: center;">
...
<section id="main">
	<div class="container">
        ...
        <img src="img/REPUBLICA-DOMINICANA-LO-TIENE-TODO.jpg" width="100%" />
