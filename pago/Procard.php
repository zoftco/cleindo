...
class ProcardConfig
{
    ...
    public $pass = "d5fa92d0da1cbe0e9f7e46459b41303fe3129c59";
...
{
    #Ruta al certificado
    const ECOM_CERT_PATH = "ecom.procard.com.py.cer";
    #Url del gateway de pagos
    const ECOM_ROOT_CTX = "https://ecom.procard.com.py/v4";
...
# Nueva instancia PDO
$db = new PDO('mysql:host=localhost;dbname=zadmin_procard', 
			  'root', 
			  '', 
			  array(
