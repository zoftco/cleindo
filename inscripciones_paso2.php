<!-- Paso 2 Paraguayo Estudiante - Subir Factura y CI -->
		...
		<article>
			...
			<form action="inc/uploadimages.php" method="post" enctype="multipart/form-data">
				<div class="form">
					...
					<div class="form-row">
						<label for="name">Foto de Cédula de Identidad</label>
						<input type="file" name="fotoCedula" id="fotoCedula" required>
					</div>
					
					<div class="form-row">
						<label for="name">Foto de Factura de Cuota o Matrícula de estudios</label>
