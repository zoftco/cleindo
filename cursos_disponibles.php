...
<section id="main">
	<div class="container">
		<!--
		<article>
			<h4>Recibirás un mail de confirmación para que puedas volver a nuestra página y empezar a inscribirte a los cursos.</h4>


		</article>
		-->
		<!-- Sidebar -->
		<h4 style="font-weight: bold;">CURSOS</h2>
		...
		<h4 style="font-weight: bold;">VISITAS</h2>
		<table id="visitas">
			<thead class="txtC">
				<tr>
					<th>Industria</th>
