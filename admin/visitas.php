...
<html lang="en">
    ...
    <body>
        	...
        	<div class="col-sm-12">
                <div class="visitapanel panel panel-default">
            	    <div class="panel-heading">
                        <h4 class="panel-title"><span class="glyphicon glyphicon-user"></span> Visitas	</h4>
                    </div>
                    <div class="addvisitabtn" style="margin: 20px 20px 0 0; display: inline-block; float:right;">
                    	<p><span class="glyphicon glyphicon-plus"></span> Crear visita</p>  
                    </div>
        ...
        <script src="js/visitacontroller.js"></script>
    </body>
 </html>	   