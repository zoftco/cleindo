                ...
                ?>
                    ...
                    <div id="pagoPaypal" class="card">
                        ...
                        <div id="collapseOne" class="collapse" aria-labelledby="headingOne" data-parent="#accordion">
                            <div class="card-body">
                                <p>El monto de la inscripción es de: <?php echo $pagarpaypal;?> USD</p>
                                <p>El cargo de Paypal o Tarjeta de Crédito es de <?php echo $pagartarjeta-$pagarpaypal;?> USD</p>
                                                                ...
                                                                item_list: {
                                                                    items: [
                                                                        ...
                                                                        },
                                                                        {
                                                                            ...
                                                                            description: "Profesional <?php echo $_SESSION['etapa']; ?>",
                                                                            quantity: "1",
                                                                            price: "<?php echo $pagartarjeta-$pagarpaypal; ?>",
                                                                            currency: "USD"
                                                                        }
                                                                    ]
                                                                }
